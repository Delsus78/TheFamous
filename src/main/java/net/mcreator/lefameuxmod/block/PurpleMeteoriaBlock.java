...
public class PurpleMeteoriaBlock extends LefameuxmodModElements.ModElement {
	@ObjectHolder("lefameuxmod:purple_meteoria")
	public static final Block block = null;
	public PurpleMeteoriaBlock(LefameuxmodModElements instance) {
		super(instance, 40);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0.5f, 0f).lightValue(1));
			setRegistryName("purple_meteoria");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Strange rose huh ?"));
		}
