...
public class ThiccMeteoriaRoseBlock extends LefameuxmodModElements.ModElement {
	@ObjectHolder("lefameuxmod:thicc_meteoria_rose")
	public static final Block block = null;
	public ThiccMeteoriaRoseBlock(LefameuxmodModElements instance) {
		super(instance, 37);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("thicc_meteoria_rose");
		}
