...
public class ThiccPurpleMeteoriaBlock extends LefameuxmodModElements.ModElement {
	@ObjectHolder("lefameuxmod:thicc_purple_meteoria")
	public static final Block block = null;
	public ThiccPurpleMeteoriaBlock(LefameuxmodModElements instance) {
		super(instance, 41);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("plains")))
				biomeCriteria = true;
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("lefameuxmod:meteorite_biome")))
				biomeCriteria = true;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(1f, 0f).lightValue(2));
			setRegistryName("thicc_purple_meteoria");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Thicc Strange rose huh ?"));
		}
