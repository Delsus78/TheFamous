...
public class PsychoEntity extends LefameuxmodModElements.ModElement {
	public static EntityType entity = null;
	public PsychoEntity(LefameuxmodModElements instance) {
		super(instance, 29);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("psycho")
						.setRegistryName("psycho");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -10079488, -205, new Item.Properties().group(LeFameuxModItemGroup.tab)).setRegistryName("psycho"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 25, 1, 5));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelsteve(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("lefameuxmod:textures/psycho_textures.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 30;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(MeteoriteAxeItem.block, (int) (1)));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, MobEntity.class, false, true));
