...
public class MeteoriteSwordItem extends LefameuxmodModElements.ModElement {
	@ObjectHolder("lefameuxmod:meteorite_sword")
	public static final Item block = null;
	public MeteoriteSwordItem(LefameuxmodModElements instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		...
		}, 3, -1f, new Item.Properties().group(LeFameuxModItemGroup.tab)) {
			@Override
